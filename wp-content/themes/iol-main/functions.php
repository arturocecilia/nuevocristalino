...
if (function_exists('register_sidebar')) {
   ...
   'name' => __('menusite'),
   'id' => 'menusite',
   'description' => __('An optional widget area for the menu of your site', 'Nuevo Cristalino'),
...
register_nav_menu('Menu-footer', 'Menú para el footer');
register_nav_menu('Menu-Blog', 'Menú para el blog');
//register_nav_menu('Menu-cat-QA', 'Menú de categorías del qa');
//register_nav_menu('Menu-QA', 'Menú para el qa');
register_nav_menu('menu-cirugia', 'Menú para las paginas de cirugia');
register_nav_menu('menu-faqs', 'Menú para las paginas de faqs');
register_nav_menu('menu-anatomia-ojo', 'Menú para las paginas de mis ojos');
register_nav_menu('menu-tipos-lentes', 'Menú para las paginas de tipos de lio');
register_nav_menu('menu-explicacion-tipos-lio', 'Menú para las explicaciones para pacientes de los tipos de lio que hay');
register_nav_menu('Menu-footer2', 'Menú para segundo menú del footer (Más sobre NC)');

//register_nav_menu('Menu-forum', 'Menú para el forum');

register_nav_menu('Menu-presbicia', 'Menú para el template de presbicia');
register_nav_menu('Menu-cataratas', 'Menú para el template de cataratas');


//Menus necesarios para el área privada
//register_nav_menu('menu-cuestionarios', 'Menú para cuestionarios');
//register_nav_menu('menu-myprofile', 'Menú para las páginas de mi perfil de nuevocristalino');
//register_nav_menu('menu-myprofile-professional', 'Menú para las páginas de mi perfil profesional de nuevocristalino');
//register_nav_menu('menu-mync', 'Menú de acceso a las secciones del Área privada');
//register_nav_menu('menu-myprofile-mync', 'Menú para las seccciones del área privada que aparecen en la página de perfil');
//register_nav_menu('menu-mync-myprofile', 'Menú para los cuestionarios que aparecen en la página de área privada');
...
'name' => __('widgetsblog'),
'id' => 'widgetsblog',
'description' => __('A third widget area for your blog', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title-blog">',
'after_title' => '</h3>',
));

register_sidebar(array(
'name' => __('registerform'),
'id' => 'registerform',
'description' => __('A 5 widget area to get a register form in blog', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
'name' => __('search'),
'id' => 'search',
'description' => __('A 5 widget area to get a search area in blog', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
'name' => __('galeria1'),
'id' => 'galeria1',
'description' => __('A 5 widget area to get a gallery in cirugia refractiva', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar(array(
'name' => __('submenu-fabricantes'),
'id' => 'submenu-fab',
'description' => __('A widget area to get a submenu in fabricantes', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar(array(
'name' => __('submenu-proveedores'),
'id' => 'submenu-prov',
'description' => __('A widget area to get a submenu for providers', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
'name' => __('menu-forum'),
'id' => 'menu-forum',
'description' => __('A widget area to get a menu in forum headers', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar(array(
'name' => __('widgets-forum'),
'id' => 'widgets-forum',
'description' => __('A widget area to get widgets in forum content', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar(array(
'name' => __('widget1-forum-footer'),
'id' => 'widget1-forum-footer',
'description' => __('A widget area to get widgets in forum footer about topics', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
register_sidebar(array(
'name' => __('widget2-forum-footer'),
'id' => 'widget2-forum-footer',
'description' => __('A widget area to get widgets in forum footer about forums', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
*/
/*Registramos un widget area para contener las FAQs en Presbicia.*/
register_sidebar(array(
    'name' => __('widget3-faqs-presbicia'),
    'id' => 'widget3-faqs-presbicia',
    'description' => __('Un widget area bajo el widget que contiene el submenú en presbicia', 'iol'),
    'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
    'after_widget' => "</aside>",
    'before_title' => '<h3 class="widget-title">',
    'after_title' => '</h3>',
...
register_sidebar(array(
    'name' => __('widget4-faqs-cataratas'),
    'id' => 'widget3-faqs-presbicia',
    'description' => __('Un widget area bajo el widget que contiene el submenú en template cataratas', 'iol'),
    'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
    'after_widget' => "</aside>",
    'before_title' => '<h3 class="widget-title">',
    'after_title' => '</h3>',
...
/*register_sidebar( array (
'name' => __( 'contacto-single-lentes'),
'id' => 'contacto-single-lentes',
'description' => __( 'A widget area to get a contact form in single lentes', 'iol'),
'before_widget' => '<aside id="%1$s" class="widget-container %2$s">',
'after_widget' => "</aside>",
'before_title' => '<h3 class="widget-title">',
'after_title' => '</h3>',
...
function iol_scripts_styles()
{
    ...
    wp_enqueue_script('theme-load-js', $tempPathLoad, array(), '1.0', true);//'jquery-cookie','jquery-ui-tooltip'
    ...
    //Las fuentes ahora, con el problema de firefox y el cross  =>> LO HAREMOS A CAPÓN¡¡¡
...
add_action('after_setup_theme', 'iol_main_setup');
function iol_main_setup()
{
    //var_dump(load_theme_textdomain('iol-main', get_template_directory() . '/languages'));


    load_child_theme_textdomain('iol-main', get_stylesheet_directory() . '/languages');
}
...
{
    //global $switched, $wp_taxonomies;

    //switch_to_blog($relQAsite_ID);
    //$categories = get_terms('dwqa-question-category');
    $categories   = wp_get_post_terms($id_question, 'dwqa-question_category'); //,$args


    //echo PHP_EOL.$id_question.PHP_EOL;
    //echo PHP_EOL.$relQAsite_ID.PHP_EOL;
...
function truncateCustom($text, $id, $chars = 50)
{
    ...
    return $text;
           ...
           function get_forumFeatImg($idElement)
           {
               ...
               $idForumPriceIol = array(12220,13141);
...
//Redirect de Perfil a login si no está logueado
add_action('template_redirect', function () {
    if (is_user_logged_in() || ! is_page()) {
        return;
    }

    $restricted = array( 70 ); // all your restricted pages

    if (in_array(get_queried_object_id(), $restricted)) {
        $loginUrl = get_permalink(64);
        wp_redirect($loginUrl);//site_url('/user-registration')
        exit();
    }
});

//Redirect de Register a Profile si está logueado
add_action('template_redirect', function () {
    //Si no está logeado o no está en una página esto no afecta
    if (!is_user_logged_in() || !is_page()) {
        return;
    }
  ...
  body.wp-core-ui .button-primary{
      ...
      text-shadow: 0 -1px 1px #FEA63C, 1px 0 1px #FEA63C, 0 1px 1px #FEA63C, -1px 0 1px #FEA63C;
        ...
        #login h1 a, .login h1 a {
          background-image: url(https://www.nuevocristalino.es/wp-content/themes/iol-main/images/logo-nc.jpg);
          height: 129px;
          width: 320px;
