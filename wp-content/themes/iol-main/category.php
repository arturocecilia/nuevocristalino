...
get_header(); ?>
	...
	<section id="primary" class="site-content-blog">
		...
		<!-- Título del blog -->
		<div class="title-blog-wrapper">
			<h1><?php echo _x('Blog de lentes intraoculares Presbicia y cataratas', 'iol_main', 'iol-main'); ?>
</h1></div>
		<!-- -->
...
//  include(get_stylesheet_directory() . '/facebook-like.php');
  ?>
    ...
    <?php // include(get_stylesheet_directory() . '/widget-surgeons.php')?>
    <!-- Fin añadido widget -->
