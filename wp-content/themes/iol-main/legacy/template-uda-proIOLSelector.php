<?php
/*
 * Template Name: Template UDA proIOLSelector
...
if ( have_posts() ) {
	...
	<br /><br />
		...
		//
          ...
          include(ABSPATH . 'wp-content/plugins/user-analysis/iolSelector-proUserMetadataProcessor.php');
  				//include(ABSPATH . 'wp-content/plugins/user-analysis/iolSelector-userMetadataProcessor.php'); //De momento dejamos este que el otro está mal
     ?>
...
<?php
        ...
        if ( $queryRTest->have_posts() ) {
            ...
            echo '<span>';
            printf(_x('A continuación le mostramos &nbsp;<strong>%d</strong>&nbsp; lentes intraoculares recomendadas de acuerdo a sus respuestas.','template-uda-proiolselector','iol_last'),$queryRTest->found_posts);
