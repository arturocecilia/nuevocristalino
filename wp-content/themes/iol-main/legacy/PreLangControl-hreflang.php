...
if( !(! empty( $_SERVER[ 'HTTP_X_REQUESTED_WITH' ] ) && strtolower( $_SERVER[ 'HTTP_X_REQUESTED_WITH' ]) == 'xmlhttprequest') ) {
  ...
  function hrefLangGenerator($id_MainQ){
    ...
    $ncWPSitesDomains= array(
                'es-ES'     =>      'http://www.nuevocristalino.es',
                'es-MX'     =>      'http://www.nuevocristalino.mx',
                'en-GB'     =>      'http://www.newlens.co.uk',
                'de-DE'     =>      'http://www.neuelinsen.com',
                'es-CO'     =>      'http://www.nuevocristalino.co',
                //'fr_FR'     =>      6,
                'es-CL'     =>      'http://www.nuevocristalino.cl',
                'de-AT'     =>      'http://www.neuelinsen.at',
                'en-US'     =>      'http://www.mylifestylelens.com');
     ...
     $ncWPLangsDomains = array(
                        'es'     =>      'http://www.nuevocristalino.es',
                        'en'     =>      'http://www.newlens.co.uk',
                        'de'     =>      'http://www.neuelinsen.com'                
                    );
...
if(is_single() && ($post_typeT == _x('lente-intraocular','CustomPostType Name','iol') || $post_typeT == _x('fabricante','CustomPostType Name','fabricante') || $post_typeT == 'post' )){
   ...
   if( $post_typeT == _x('fabricante','CustomPostType Name','fabricante')  ){
    ...
    foreach($ncWPLangs as $key=>$value){
        ...
        switch_to_blog($value);
         $postLink =  get_permalink( $id_MainQ ) ;
