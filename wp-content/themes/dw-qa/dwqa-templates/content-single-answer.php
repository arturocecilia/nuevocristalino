...
<div class="answerDetails">
		<?php printf(__('<span class="answerAuthor"><a href="%s">%s%s</a></span><span class="barravertical">&nbsp;|&nbsp;</span><span class="answerDate"> %s answered %s ago</span>', 'dwqa'), dwqa_get_author_link($user_id), get_avatar($user_id, 48), get_the_author(), dwqa_print_user_badge($user_id), human_time_diff(get_post_time('U', true))) ?>
</div>
