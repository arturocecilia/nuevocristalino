...
<div class="dwqa-question-item">
	...
	<div class="dwqa-question-header">
	<?php echo '<div class="dwqa-question-title" ><h1>'.get_the_title().'</h1></div>'; ?>
...
<div class="qa-user-date"><?php echo get_the_date(); ?></div>
<div class="barravertical"></div>
<div class="qa-user-box"><?php echo get_the_author_meta('display_name'); ?></div>
<div class="questionCateg"><?php echo get_the_term_list(get_the_ID(), 'dwqa-question_category', '<span class="dwqa-question-category">', ', ', '</span>');?></div>
