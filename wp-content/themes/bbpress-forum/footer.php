	    ...
	    <!--<div id="mVisitedWrapper"> -->
        		...
        		<!-- Inicio de las Lentes m‡s visitadas-->
           		...
           		<?php
                            ...
                            $main_site_id = $capsule->table('nc_sites_groups')
                                                    ->where('group_site_key', get_locale())
                                                    ->first()->main_site_id;

                     $argsIols = array('post_type'=>_x('lente-intraocular', 'bbpress_forum', 'bbpress-forum'),
...
//switch_to_blog($main_site_id);
                     ...
                     $argsClinics = array(	'post_type'=>_x('clinica', 'bbpress_forum', 'bbpress-forum'),
