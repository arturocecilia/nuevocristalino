  ...
  body.wp-core-ui .button-primary{
      ...
      text-shadow: 0 -1px 1px #FEA63C, 1px 0 1px #FEA63C, 0 1px 1px #FEA63C, -1px 0 1px #FEA63C;
        ...
        #login h1 a, .login h1 a {
          background-image: url(https://www.nuevocristalino.es/wp-content/themes/bbpress-forum/images/logo-nc.jpg);
          height: 129px;
          width: 320px;
...
add_action('after_setup_theme', 'bbpress_forum_setup');
function bbpress_forum_setup()
{
    //var_dump(load_theme_textdomain('iol-main', get_template_directory() . '/languages'));


    load_child_theme_textdomain('bbpress-forum', get_stylesheet_directory() . '/languages');
}
