...
function iol_scripts_styles()
{
    ...
    wp_enqueue_script('theme-load-js', $tempPathLoad, array('qa-js','jquery-cookie','jquery-ui-tooltip'), '1.0', true);//'jquery-cookie',
  ...
  body.wp-core-ui .button-primary{
      ...
      text-shadow: 0 -1px 1px #FEA63C, 1px 0 1px #FEA63C, 0 1px 1px #FEA63C, -1px 0 1px #FEA63C;
        ...
        #login h1 a, .login h1 a {
          background-image: url(https://www.nuevocristalino.es/wp-content/themes/iol-proms/images/logo-nc.jpg);
          height: 129px;
          width: 320px;
...
add_action('after_setup_theme', 'iol_proms_setup');
function iol_proms_setup()
{
    //var_dump(load_theme_textdomain('iol-main', get_template_directory() . '/languages'));


    load_child_theme_textdomain('iol-proms', get_stylesheet_directory() . '/languages');
}
...
{
    //flush_rewrite_rules();
    add_rewrite_rule('^(.*)', 'index.php?is_home=true&proms_slug=$matches[1]', 'top');
}
