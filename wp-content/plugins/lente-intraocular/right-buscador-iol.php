...
<input name="pt" type="hidden" value="no" />

<!-- Metemos un input Hidden de manera que se pueda indentificar en el ajax handler que venimos del buscador -->

<input name="buscador" type="hidden" value="TRUE" />
            ...
            foreach ($filtros as $taxonomyFiltr ) {
                if($taxonomyFiltr->slug == _x('luz-ultravioleta','taxo-value-slug','iol-scaffold')){
                 ...
                 if($taxonomyFiltr->slug == _x('luz-azul','taxo-value-slug','iol-scaffold')){
                       ...
                       if($taxonomyFiltr->slug == $Result_filtros)
                           {
                             echo '<input type="checkbox" id="LuzAzul" checked="checked"  name="'._x('luz-azul','taxo-value-slug','iol-scaffold').'" value='.$taxonomyFiltr->slug.' /><label for="LuzAzul">'._x('Luz Azul','taxo-value-name','iol-scaffold').'</label>';
                           }
                       else{
                             echo '<input type="checkbox" id="LuzAzul"  name="'._x('luz-azul','taxo-value-slug','iol-scaffold').'" value='.$taxonomyFiltr->slug.' /><label for="LuzAzul">'._x('Luz Azul','taxo-value-name','iol-scaffold').'</label>';
                           }
                       }
                   }
  ...
  <div id="advancedAccordionFilter">
        ...
        <div>
           ...
           <div class="spanH4Wrapper startsUgly">
            <div id="advDisablerDiv">
            <span id="spanAdvFilDisabler" class="startsUgly"><?php echo _x('No aplicar estos filtros:','Right Archive Lente Intraocular','iol_cpt_display');?></span> 
            <button id="advancedFiltersDisabler"> Advanced Filters Disabler </button>
            </div>        
         
            <div id="advEnablerDiv">   
              <span id="spanAdvFilEnabler"  class="startsUgly"><?php echo _x('Aplicar estos filtros:','Right Archive Lente Intraocular','iol_cpt_display');?></span> 
              <button id="advancedFiltersEnabler">Advanced Filters Enabler</button> 
           </div>
...
<?php			
 ...
 <div id="surgeonAccordionFilter">
     ...
     <div>
         <div class="spanH4Wrapper startsUgly">
           <div id="surgEnablerDiv">
             <span id="spanSurgeonFilEnabler"  class="startsUgly"><?php  echo _x('Aplicar estos filtros:','Right Archive Lente Intraocular','iol_cpt_display');?></span> 
             <button id="surgeonFiltersEnabler">Surgeon Filters Enabler</button> 
           </div>
           
             <div id="surgDisablerDiv">
            <span id="spanSurgeonFilDisabler" class="startsUgly"><?php  echo _x('No aplicar estos filtros:','Right Archive Lente Intraocular','iol_cpt_display');?></span> 
            <button id="surgeonFiltersDisabler"> Surgeon Filters Disabler </button>
           </div>            
                         
          <!--  <h4><?php /* echo _x('Rangos Dioptricos','Right Archive Lente Intraocular','iol_cpt_display');*/ ?></h4>-->
          </div>
