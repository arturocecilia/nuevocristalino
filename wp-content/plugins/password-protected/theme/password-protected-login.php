...
<div id="login">
	<h1>
		<!-- <a href="<?php echo esc_url( apply_filters( 'password_protected_login_headerurl', home_url( '/' ) ) ); ?>" title="<?php echo esc_attr( apply_filters( 'password_protected_login_headertitle', get_bloginfo( 'name' ) ) ); ?>"><?php bloginfo( 'name' ); ?></a>
			-->
	...
	<form name="loginform" id="loginform" action="<?php echo esc_url( $Password_Protected->login_url() ); ?>" method="post">
		...
		<?php endif; ?>
		<p>La red de sites de nuevocristalino ya no está activa</p>
		<p>TNewlens, Mylifestylelens and Neuelinsen are no longer available</p>
